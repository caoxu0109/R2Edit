...
def summarize(
    ...
    #for run_dir in [Path(abs_path)]:
        ...
        for case_file in files:
            ...
            attack_probes_p_original_correct = data['post']['attack_probes_p_original_correct']
            attack_probes_p_old_gt_new = data['post']['attack_probes_p_old_gt_new']
            attack_probes_em_original_correct = data['post']['attack_probes_em_original_correct']
            attack_probes_em_old_gt_new = data['post']['attack_probes_em_old_gt_new']
            cur_sum["attack_probes_p_original_correct"].append(np.mean(attack_probes_p_original_correct))
            cur_sum["attack_probes_p_old_gt_new"].append(np.mean(attack_probes_p_old_gt_new))
            cur_sum["attack_probes_em_original_correct"].append(np.mean(attack_probes_em_original_correct))
            cur_sum["attack_probes_em_old_gt_new"].append(np.mean(attack_probes_em_old_gt_new))
            ...
            for prefix in ["pre", "post"]:
                ...
                for key in ["rewrite", "paraphrase", "neighborhood","forget"]:
        ...
        for prefix in ["pre", "post"]:
            for k_efficacy, k_generalization, k_specificity, k_forget in [
                ...
                if all(k in cur_sum for k in [k_efficacy, k_generalization, k_specificity, k_forget]):
                    hmean_list = [
