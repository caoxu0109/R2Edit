...
DS_DICT = {
    ...
    "zsre_relation": (RelaDataset, compute_rewrite_quality_zsre),
    "zsre_twostep": (RelaTwoStepDataset, compute_rewrite_quality_zsre),
    "zsre_ob": (RelobjectDataset, compute_rewrite_quality_zsre),
}
    ...
    for record_chunks in chunks(ds, num_edits):
        ...
        for item in record_chunks:
            if len(item) == 1:
                ...
                raise ValueError(f"Unexpected number of items in record: {len(item)}. Expected 1, 2.")
        all_data = first_chunk + second_chunk 
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ds_name",
        choices=["mcf", "cf", "zsre", "mquake","zsre_relation","zsre_twostep","zsre_ob"],
        default="zsre",
